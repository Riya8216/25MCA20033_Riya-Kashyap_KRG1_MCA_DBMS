...
ALTER TABLE Tbl_Products
ADD FOREIGN KEY (sup_id) REFERENCES Tbl_Suppliers(sup_id);
Select s.sup_id,p.prod_name,o.qty from Tbl_Orders o JOIN Tbl_Products p ON o.prod_id=p.prod_id
...
VALUES (9003, 501, 103, CURRENT_DATE, 2);
SELECT * FROM Tbl_Products WHERE prod_id = 501;